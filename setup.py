...
setup(
    name="mailman_schema",
    version="1.0.0",
    description="A schema package for messages",
    long_description=README,
    url="https://github.com/ethanparab/fedora-message-schema/",
    ...
    license="GPLv2+",
    maintainer="Ethan Parab",
    maintainer_email="ethanparab@yahoo.com",
    ...
    entry_points={
        "fedora.messages": [
            ...
            "mailman.messageV4=mailman_schema.schema:MessageV4",
        ]
    },
)
